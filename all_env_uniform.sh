...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=2 python experiment.py --dir $DIR --env $ENV --data_mode _formal --concat_state_pref $CSP --concat_rtg_pref $CRP --concat_act_pref $CAP --mo_rtg True --seed 4 --dataset newmedium_uniform --model_type $MODEL --num_steps_per_iter $STEP --max_iters $ITER &
            CUDA_VISIBLE_DEVICES=2 python experiment.py --dir $DIR --env $ENV --data_mode _formal --concat_state_pref $CSP --concat_rtg_pref $CRP --concat_act_pref $CAP --mo_rtg True --seed 5 --dataset newmedium_uniform --model_type $MODEL --num_steps_per_iter $STEP --max_iters $ITER &
            CUDA_VISIBLE_DEVICES=2 python experiment.py --dir $DIR --env $ENV --data_mode _formal --concat_state_pref $CSP --concat_rtg_pref $CRP --concat_act_pref $CAP --mo_rtg True --seed 6 --dataset newmedium_uniform --model_type $MODEL --num_steps_per_iter $STEP --max_iters $ITER &
            wait
        done
    done
done
